...
{
    public partial class frmWritingPhucTra : Form
    {
        private int _contestID;
        public int _TypeShow;
        private int _locationID { get; set; }
        public frmWritingPhucTra(int Contestid ,int LocationID)
        {
            InitializeComponent();
        ...
        public void InitControl()
        {
            pnlMain.Controls.Clear();
                ...
                Control.ucWrittingPhucTra uc = new Control.ucWrittingPhucTra(_contestID,_locationID);
