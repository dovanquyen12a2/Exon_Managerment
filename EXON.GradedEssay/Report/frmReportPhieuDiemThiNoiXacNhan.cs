...
{
    public partial class frmReportPhieuDiemThiNoiXacNhan : Form
    {
        #region Service
        ...
        public frmReportPhieuDiemThiNoiXacNhan(int DivisionShiftID, string TeacherName1, string TeacherName2,int SubjectID)
        {
            InitializeComponent();
            InitializeService();
                ...
                if (lstcs.Count > 0)
                {
                    ...
                    var listKetQua = lstcs
                                       .Select(p => new
                                       {
                                           ...
                                           DiemThi = KetQuaNoi(p.ContestantShiftID)
                                       })
                                       .ToList();
