...
{
    public partial class frmReportPhieuDiemThiViet : Form
    {
        #region Service
        ...
        public frmReportPhieuDiemThiViet(int DivisionShiftID, string TeacherName1, string TeacherName2,int subjectID)
        {
            InitializeComponent();
            InitializeService();
